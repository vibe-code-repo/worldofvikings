 ...
 * private asset store, and writes their manifest rows (ADR-0015, ADR-0064).
 *
 * ```bash
...
/** One shared stand-in for every private clip; see ADR-0064. */
...
const placeholderEntry: AssetEntry = {
  ...
  origin:
    ...
    `because a sound has no hull to get wrong (ADR-0064).`,
