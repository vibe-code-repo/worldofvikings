...
const AUSNAHMEN = [
  ...
  { pfad: 'tools/test/weltkarte-probe.mjs', art: 'werkzeug', grund: 'rendert zwei 4096er-Karten aus den Weltdokumenten (~50 s, sharp), Probe für die Veröffentlichung; kein Sammellauf-Test' },
