"""Build Crowshade armor, female body (one-call entry point).
...
Blender --factory-startup -b BODY_BASE_FEMALE.blend --python-exit-code 1 \\
        --python tools/armor/sets/crowshade/female/build.py -- OUTPUT_DIR [--quick] [--female]

Result: equipment.json in OUTPUT_DIR carries bodyVariant "female", bodyProfile
"wov-female-v1", figure "wikingerin" and item ids "crowshade_female_<key>".
