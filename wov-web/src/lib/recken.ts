...
export const TAFELN: Tafel[] = [
  {
    id: 'rang',
    titel: 'characters.board.rank.title',
    spalte: 'characters.board.rank.column',
    wert: (r) => r.stufe,
  ...
  {
    id: 'waechter',
    titel: 'characters.board.guardian.title',
    spalte: 'characters.board.guardian.column',
  ...
  {
    id: 'fahrt',
    titel: 'characters.board.voyage.title',
    spalte: 'characters.board.voyage.column',
  ...
  {
    id: 'hel',
    titel: 'characters.board.hel.title',
    spalte: 'characters.board.hel.column',
    wert: (r) => r.tode,
