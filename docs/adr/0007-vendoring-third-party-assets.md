# ADR-0007: Vendoring third-party assets, and two entry points for `@wov/asset-system`
...
ADR-0006 built the machinery to load assets. This is the first time a real,
