"""Build Crowshade armor, male body (one-call entry point).
...
Blender --factory-startup -b BODY_BASE_MALE.blend --python-exit-code 1 \\
        --python tools/armor/sets/crowshade/male/build.py -- OUTPUT_DIR [--quick]

Result: equipment.json in OUTPUT_DIR carries bodyVariant "male", bodyProfile
"wov-male-v1", figure "wikinger" and item ids "crowshade_male_<key>".
"""
import runpy
import sys
