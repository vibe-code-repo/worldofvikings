# Erzeugt: dasselbe M1-Nachweisbild als Außenansicht (34 mm), damit der Baukörper als Ganzes sichtbar wird.
...
cam_d = bpy.data.cameras.new("cam"); cam_d.lens = 34
cam = bpy.data.objects.new("cam", cam_d); bpy.context.scene.collection.objects.link(cam)
bpy.context.scene.camera = cam
cam.location = Vector((6.5, 4.0, 6.5))
cam.rotation_euler = (Vector((-0.6, -3.0, 0.4)) - cam.location).to_track_quat("-Z", "Y").to_euler()
