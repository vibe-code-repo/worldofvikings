...
console.log('▶ Quelltextprüfung editorMain.ts');
{
  ...
  check(`Ersetzen ohne Weiterbauen ruft merkeSchritt(true): Import, Serverstand (Start-Abgleich), Serverstand nach 409, wieder einsetzen, Welt zurücksetzen (${ersetzenStellen} Stellen, erwartet 5)`, ersetzenStellen === 5, String(ersetzenStellen));
