...
>   durchgängig voraus, dass der Extraktions-Export vorliegt: `preloadModels` über ~43
...
8. **Keine Re-Arbeit am Server nötig:** Alle Referenz-Verifikationen (geo-compare bit-exakt, heightmap-compare, b5-ashlands) gelten für das Babylon-Repo unverändert, da `shared/` identisch ist.
