...
/**
 * The only two modules allowed to name a physics backend (ADR-0013): the
  ...
  forbidden: [
    ...
    },
    {
      ...
      comment:
        ...
        'physics backend (ADR-0013). Everything else uses the PhysicsWorld contract from ' +
    ...
    },
    {
      ...
      comment:
        ...
        'the reason the backend sits behind a separate entry point (ADR-0013, spec §38).',
      severity: 'error',
