 ...
 * Vergleichsprojekts, §3. Der dortige Befund ist die Regel hier: Jeder Hash, den Server UND Client
 ...
 * die Falle in `tombSlotRoll`/`hash2` des Vergleichsprojekts).
 * Source: `design/ARCHITECTURE.md` W6/W7/W8, detailed in the comparison-project
 ...
 * comparison project's `tombSlotRoll`/`hash2`).
 *
 ...
 * Belange" aus der Vergleichsprojekt-Analyse §3 (`mixSeed`), Grundlage von W7: ein eigener
 ...
 * the comparison-project analysis §3 (`mixSeed`), the basis of W7: an own `XorShiftRandom`
