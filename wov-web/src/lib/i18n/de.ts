...
export const de = {
  ...
  /* Forum M2: Bretteruebersicht, Themenliste, Thema und Blaettern. */
  'thing.boards.back': 'Alle Bretter',
  'thing.board.empty': 'In diesem Brett steht noch nichts.',
  'thing.threads.table.thread': 'Thema',
  'thing.threads.table.replies': 'Antworten',
  'thing.threads.table.last': 'Letzte Regung',
  'thing.threads.opened_by': 'eröffnet von',
  'thing.thread.pinned': 'Angeheftet',
  'thing.thread.locked': 'Gesperrt',
  'thing.post.edited': 'bearbeitet',
  'thing.post.deleted': 'Dieser Beitrag wurde entfernt.',
  'thing.pager.page': 'Seite',
  'thing.pager.of': 'von',
  'thing.pager.prev': 'Zurück',
  'thing.pager.next': 'Weiter',
  'thing.unreachable': 'Der Forendienst ist gerade nicht erreichbar.',
  /* Forum M3: Schreiben, Bearbeiten, Loeschen. */
  'thing.write.new_thread': 'Neues Thema',
  'thing.write.reply': 'Antworten',
  'thing.write.title': 'Titel',
  'thing.write.body': 'Beitrag',
  'thing.write.markdown_hint': 'Markdown: **fett**, *kursiv*, `Code`, > Zitat, [Link](https://…)',
  'thing.write.as': 'Schreiben als',
  'thing.write.submit_thread': 'Thema anlegen',
  'thing.write.submit_reply': 'Antwort senden',
  'thing.write.busy': 'Wird gesendet …',
  'thing.write.signin_hint': 'Zum Schreiben bitte anmelden.',
  'thing.write.no_character': 'Dieses Konto hat noch keinen Charakter.',
  'thing.write.edit': 'Bearbeiten',
  'thing.write.delete': 'Löschen',
  'thing.write.save': 'Speichern',
  'thing.write.cancel': 'Abbrechen',
  'thing.write.error.not-signed-in': 'Nicht angemeldet.',
  'thing.write.error.character-invalid': 'Charakter ungültig.',
  'thing.write.error.title-invalid': 'Der Titel braucht 3 bis 120 Zeichen.',
  'thing.write.error.body-invalid': 'Der Text braucht 1 bis 20000 Zeichen.',
  ...
  'thing.mod.reported': 'Danke — gemeldet.',
  'thing.mod.pin': 'Anheften',
  'thing.mod.unpin': 'Nicht mehr anheften',
  'thing.mod.lock': 'Sperren',
  'thing.mod.unlock': 'Entsperren',
  'thing.mod.title': 'Moderation',
  'thing.mod.reports': 'Offene Meldungen',
  'thing.mod.empty': 'Keine offenen Meldungen.',
  ...
  'create.stage.zoom_head': 'Auf den Kopf zoomen',
  'create.stage.zoom_out': 'Zurück zur Übersicht',
  'create.helmet.hide': 'Helm ausblenden',
  'create.helmet.show': 'Helm anzeigen',
  ...
  'create.footer.hint': 'Ziehen dreht die Figur, Rad zoomt, Klick auf den Kopf holt ihn heran.',
  ...
  */
  ...
  'account.error.timeout': 'Der Server antwortet nicht — bitte später noch einmal versuchen.',
